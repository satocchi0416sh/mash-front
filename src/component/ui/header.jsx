...
import { AccountCircle, AddCircleOutline, ExpandLess, ExpandMore, Home, Email, ShoppingCart, Help, Favorite, Search, LoginOutlined, LogoutOutlined, MenuSharp, Settings, } from "@mui/icons-material"
...
const Header = memo((props) => {
    ...
    const { isLoggedIn, id, logout, cartNumber, likeNumber } = props
    console.log(cartNumber, likeNumber)
