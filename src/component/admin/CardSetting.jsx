    ...
    return (
        <div className="top-page">
            ...
            {cardList.map((data,index) => {
                return(
                    <CardDisplay key={index} cardId={data.cardId} cardname={data.cardname}
                    cardImage={data.cardImage} price={data.price} stock={data.stock}
                    type={data.type} rea={data.rea} series={data.series} number={data.number}
                    search={search}/>
                )
            })}
        </div >
